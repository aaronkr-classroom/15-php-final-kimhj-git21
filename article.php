...
$uploads = dirname(__DIR__. 1) . DIRECTORY_SEPARATOR . 'uploads';
...
$errors['warning'] = 'Please correct the errors below';
  ...
  try {
    ...
    if ($id) {
      ...
      unset($arguments['id']);
      $spl = "INSERT INTO article (title, summary, content, category_id, member_id, image_id, published) 
